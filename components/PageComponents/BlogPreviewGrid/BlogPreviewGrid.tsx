...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Solar Tips & Insights',
  subtitle    = 'Practical advice for Central Texas homeowners — solar payback, battery backup, and how to choose an installer you can trust.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
