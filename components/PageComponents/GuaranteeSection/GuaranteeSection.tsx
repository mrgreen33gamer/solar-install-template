...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  {
    icon: faShieldHalved,
    title: "25-Year Panel Performance Support + 10-Year Workmanship",
    description:
      "Panel performance support for 25 years plus 10 years of workmanship coverage. If our install work fails within the warranty period, we make it right.",
  },
  {
    icon: faRotateLeft,
  ...
  },
  {
    ...
    description:
      "Every solar technician who enters your home is NABCEP-aligned. No unlicensed subs working alone — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every solar company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, NABCEP-aligned solar technicians, and a 25-Year Panel Performance Support + 10-Year Workmanship on every install we touch.
          </p>
          <Link
            href={ctaLink}
