...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `solar Service in ${cityName}, TX`;
  const displayDesc     = description ??
    `SunPeak Solar provides fast, reliable solar installation and service to ${cityName} and all surrounding communities. Licensed technicians, flat-rate pricing, 1-year warranty on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12548101010" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
