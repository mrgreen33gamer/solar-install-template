  ...
  return (
    <section className={styles.heroSection}>
      ...
      <div className={styles.heroContainer}>
        ...
        >
          <span className={styles.eyebrow}>Since 2016 · {cityName}, TX</span>
          <h1 className={styles.heroTitle}>
            Central Texas solar<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            SunPeak Solar has been powering homes and businesses with solar in{' '}
          ...
          <div className={styles.imageFrame}>
            <div className={styles.imageWrapper}>
              <Image
                ...
                alt="SunPeak Solar — Waco, Texas solar technicians"
                fill
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>SunPeak Solar</span>
                <span className={styles.trustCardSub}>Waco&apos;s Trusted Solar Installer</span>
              </div>
            </div>
          </div>
        </motion.div>
