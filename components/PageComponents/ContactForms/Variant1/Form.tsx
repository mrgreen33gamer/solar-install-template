...
const SERVICES = [
  { icon: faWrench,          label: 'Residential Solar' },
  { icon: faLink,            label: 'Commercial Solar' },
  { icon: faDoorOpen,        label: 'Battery Storage' },
  { icon: faCogs,            label: 'EV Charger + Solar' },
  { icon: faClipboardList,   label: 'System Monitoring' },
  { icon: faBuilding,        label: 'Solar Maintenance' },
  { icon: faBolt,            label: 'General Inquiry' },
];
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'NABCEP · Insured' },
  { icon: faStar,         text: '4.9★ · 500+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed SunPeak Solar technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12548101010"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 810-1010', section: 'ContactForm-V1' })}>
                          Call (254) 810-1010
                        </a>
                      </span>
                    </div>
