...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Solar System Needs',
  subheading = 'From residential installs to battery storage, EV charging, monitoring, and maintenance — SunPeak Solar handles it all.',
