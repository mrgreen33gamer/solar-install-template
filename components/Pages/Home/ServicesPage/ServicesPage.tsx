  ...
  return (
    ...
    >
      ...
      <nav aria-label="Services navigation" style={{
        ...
        <Link href="/services">All Services — SunPeak Solar</Link>
      </nav>

      <span id={styles.backgroundImage}>
        <Image quality={100} fill style={{ objectFit: 'cover' }} sizes="100vw" src='/pages/home/services/background-image.png?v=3' alt="Background Image for Services Page - SunPeak Solar - Background" />
      </span>
    ...
    >
      ...
      >
        <Image
          ...
          src={imgSrc}
          quality={100}
          alt={`${imgAlt} - SunPeak Solar LLC - Waco TX`}
        />
      </motion.div>
    </motion.div>
  );
