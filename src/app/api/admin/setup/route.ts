...
const SITE_URL    = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://www.sunpeaksolar.com';
const BRAND_NAME  = process.env.NEXT_PUBLIC_BRAND_NAME ?? 'SunPeak Solar';
    ...
    <tr>
      <td align="center" style="padding:40px 16px;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
          ...
          <!-- Accent bar -->
          <tr>
            <td style="height:4px;background:linear-gradient(90deg,#16def9 0%,#eab308 100%);font-size:0;line-height:0;">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td style="padding:24px 40px 8px 40px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="border-radius:10px;background:#eab308;">
                    <a href="${dashboardUrl}"
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                  <td style="padding:14px 16px;font-size:13px;color:rgba(230,241,230,0.72);line-height:1.5;">
                    <strong style="color:#eab308;">Security note —</strong>
